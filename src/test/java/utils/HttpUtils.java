...
public class HttpUtils {
    ...
    public static BasicHeader formContentTypeHeader = new BasicHeader("Content-Type","application/x-www-form-urlencoded");
	...
	if ("json".equalsIgnoreCase(contentType)) {
	    return typeMethod(url, params, type);
    ...
    public static String typeMethod(String url, String params, String type) {

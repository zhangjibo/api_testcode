...
public abstract class BaseCase {
	...
	// 配置参数化变量
	EnvironmentUtils.evn.put(Const.REGISTER_MOBILEPHONE_TEXT, Const.REGISTER_MOBILEPHONE_VALUE);
	EnvironmentUtils.evn.put(Const.REGISTER_PASSWORD_TEXT, Const.REGISTER_PASSWORD_VALUE);
	EnvironmentUtils.evn.put(Const.LOGIN_MOBILEPHONE_TEXT, Const.LOGIN_MOBILEPHONE_VALUE);
